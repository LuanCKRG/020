...
const Home = () => {
    ...
    return (
        <>
            <main className='showcase dark:text-black'>
                <div className='w-full max-w-7xl min-h-screen flex flex-col gap-2 justify-center items-center sm:items-start px-6 sm:px-10 '>
                    ...
                    <div className='flex gap-4 mt-6 flex-col items-center sm:flex-row'>
                        <Link href='/signup' className='contained dark:bg-black dark:text-white px-8 py-3'>
                            {t('start')}
                        </Link>

                        <Link href='#WhyUs' className='outlined px-8 py-3 text-black !bg-transparent'>
                            {t('learn')}
                        </Link>
                    </div>
            ...
            <section className=' flex flex-col gap-6 px-6 sm:px-10 w-full max-w-5xl mx-auto pt-16' id="WhyUs">
            ...
            <div className='flex flex-col'>
                {
                    keys.map((key, i) => (
                        <FaqCard question={tFaq(`${key}.question`)} answer={tFaq(`${key}.answer`)} key={i} />
                    ))
                }
            </div>
        </div>
